...
def get_params():
    ...
    args.add_argument("-data", "--dataset", default="HW", type=str)  # ["NELL-One", "Wiki-One"]
    args.add_argument("-path", "--data_path", default="./HW", type=str)  # ["./NELL", "./Wiki"]
    ...
    args.add_argument("-dim", "--embed_dim", default=400, type=int)
    ...
    if args.dataset == 'NELL-One':
        params['embed_dim'] = 400
    elif args.dataset == 'Wiki-One':
        params['embed_dim'] = 50
    elif args.dataset == 'HW':
        params['embed_dim'] = 400 #data from drkg
